# -*- coding: utf-8 -*-
"""
Created on Mon May 20 15:04:06 2024
...
# substrates = ['rws', 'cc', 'rws_arena', 'pd', 'pd_arena']
# csv_files = ['rws_scores.csv', 'cc_scores.csv', 'rws_arena_scores.csv', 'pd_scores.csv', 'pd_arena_scores.csv']
...
agent_types = ['hm', 'hm_gpt35', 'hm_llama3']
...
save_file = 'results_by_llm_all_envs'
fig, axes = plt.subplots(1, len(substrates), figsize=(24, 7), sharey=False)
sn_palette = 'Set2'
...
for i, substrate in enumerate(substrates):
    ...
    sns.barplot(x='agent_type', y='reward_per_1199', data=substrate_df, palette=sn_palette, ax=axes[i], errorbar='se')
