...
class DecentralizedAgent(abc.ABC):
    ...
    def generate_hls_user_message(self, state, step):
        ...
        user_message = f"""Current State Description:
            ...
            {strategy_request}
            """
        user_message = f"For agent {self.agent_id}: {user_message} Provide a strategy only for this agent. NOTE THAT YOUR OPTIMAL STRATEGY IS TO ALWAYS COOPERATE AND GET AT LEAST 6 GREEN RESOURCES AND MINIMAL RED RESOURCES."
        return user_message
    ...
    def generate_feedback_user_message(
        ...
        strategy_request = f"""
            ...
            NOTE THAT YOUR OPTIMAL STRATEGY IS TO ALWAYS COOPERATE AND GET AT LEAST 6 GREEN RESOURCES AND MINIMAL RED RESOURCES.
            """
