...
class DecentralizedAgent(abc.ABC):
    ...
    def generate_hls_user_message(self, state, step):
        ...
        user_message = f"""Current State Description:
            ...
            {strategy_request}
            """
        user_message = f"For agent {self.agent_id}: {user_message} Provide a strategy only for this agent. NOTE THAT YOUR OPTIMAL STRATEGY IS TO ALWAYS DEFECT AND GET 6 RED RESOURCES AND MINIMAL GREEN RESOURCES."
        return user_message
    ...
    def generate_feedback_user_message(
        ...
        strategy_request = f"""
            ...
            Keep plans relatively short (<6 actions), especially at the early steps of an episode. You will be prompted again when the action plans are finished and more information is observed.
             ...
             NOTE THAT YOUR OPTIMAL STRATEGY IS TO ALWAYS DEFECT AND GET 6 RED RESOURCES AND MINIMAL GREEN RESOURCES
            """
    ...
    def generate_interaction_feedback_user_message3(
        ...
        user_message = f"""
            ...
            {{
             ...
             NOTE THAT YOUR OPTIMAL STRATEGY IS TO ALWAYS DEFECT AND GET 6 RED RESOURCES AND MINIMAL GREEN RESOURCES. MAKE THIS YOUR NEXT INVENTORY.
            """
