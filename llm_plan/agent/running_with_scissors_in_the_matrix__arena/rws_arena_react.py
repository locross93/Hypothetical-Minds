...
class DecentralizedAgent(abc.ABC):
    ...
    def generate_feedback_user_message(
        ...
        if after_interaction:
            ...
            The entire interaction history with all players is: {self.interaction_history}.
            """
        else:
            strategy_preamble = f"""
            Strategy Request:
        ...
        strategy_request = f"""
            ...
            Think about what strategy your opponents are playing and select a strategy to counter them based on the interaction history.
