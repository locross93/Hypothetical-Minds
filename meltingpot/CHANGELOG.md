...
## 2024 Changed the following for compatibility for Hypothetical Minds

- Added WORLD.RGB to permitted observations in meltingpot/meltingpot/scenario.py
- Modified avatar colors in RWS Repeated and PD Repeated such that different agents will have different colors
